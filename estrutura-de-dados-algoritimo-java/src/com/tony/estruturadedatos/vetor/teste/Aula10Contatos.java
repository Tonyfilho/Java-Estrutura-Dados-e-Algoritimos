...
public class Aula10Contatos {
    ...
    public Aula10Contatos() {
    }



    public Aula10Contatos(String nome, Integer telefone, String email) {
        this.nome = nome;
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        Aula10Contatos other = (Aula10Contatos) obj;
